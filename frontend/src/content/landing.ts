...
export const FAQS: FaqItem[] = [
  {
    ...
    a: "Sí. Los planes Negocio, Profesional y Enterprise incluyen una API REST con llaves por empresa para emitir comprobantes y consultar autorizaciones, RIDE y XML desde tu ERP, tu tienda en línea o tu propio sistema de ventas, con idempotencia para reintentar sin duplicar facturas. La documentación y la especificación OpenAPI están en facturon.ec/docs/api.",
  },
  {
