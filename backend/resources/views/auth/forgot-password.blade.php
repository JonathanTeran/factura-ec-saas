<x-layouts.auth title="Recuperar Contraseña" subtitle="Recupera tu acceso">
    @if(session('status'))
    ...
    <x-slot:footer>
        <a href="{{ route('login') }}" class="text-sm font-semibold text-teal-600 hover:text-teal-700 dark:text-teal-400 dark:hover:text-teal-300 transition-colors">
