            ...
            <form wire:submit="import" class="space-y-4">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach(['tipo_identificacion', 'identificacion*', 'nombre*', 'razon_social', 'email', 'telefono', 'direccion'] as $col)
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('panel.customers.index') }}" class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition text-sm font-medium">
                        Cancelar
                    </a>
